...
int main()
{
    ...
    // node n3 = helper(0, {disjoin(var(13), var(12)),
    // var(14)}); std::cout << n3 << std::endl;
    // // node n4 = disjoin(one(), zero());
    // // std::cout << n4 << std::endl;

    // std::cout << (n1 == n2) << std::endl;
    // node n4 = helper(101, {disjoin(var(13), var(12)),
    // var(14)}); std::cout << (n3 == n4) << std::endl; node
    // n5 = op(101, {disjoin(var(13), var(12)), var(15)});
    ...
    // std::cout << resolve_goal(n8, 10, var(0)) <<
    // std::endl;
    ...
    // std::cout << resolve_goal(n9, 10, invert(goal(11)))
    // << " " << n9 << std::endl; std::cout <<
    // resolve_goal(n9, 11, conjoin(goal(12), goal(13))) <<
    // " " << n9 << std::endl; std::cout << resolve_goal(n9,
