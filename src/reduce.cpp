...
//                const std::type_index& a_return_type, const bool&
//                a_allow_params, monte_carlo::simulation<choice, std::mt19937>&
...
//     auto l_functor = [l_node_func](std::list<std::any>::const_iterator
//     a_begin,
...
//                   a_data, monte_carlo::simulation<choice, std::mt19937>&
//                   a_simulation, const size_t& a_recursion_limit)
// {
//     ////////////////////////////////////////////////////
...
//     ////////////////////////////////////////////////////
//     if(a_data.empty())
//         throw std::runtime_error("Error: no data points to build model
//         from.");
...
//     // declare return type
//     const std::type_index BINNING_RETURN_TYPE =
...
//     std::list<func>::iterator l_binning_function_it =
//     a_program.m_funcs.end();
...
// //                             size_t{0}, [](size_t a_acc, const func&
// a_func)
...
// //     std::list<std::pair<std::list<std::any>, bool>> l_data{{{0, 0, 0, 1},
// 0},
// //                                                            {{0, 1, 0, 1},
// 1},
// //                                                            {{1, 0, 0, 1},
...
// //     learn_model(l_model, l_helpers, IN_SCOPE_VAR_COUNT, l_data,
// ITERATIONS,
// //     3,
// //                 10);
