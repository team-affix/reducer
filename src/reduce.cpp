...
//         // std::transform(l_param_func_range.first,
//         l_param_func_range.second,
//         //                std::back_inserter(l_choices),
//         //                [](auto a_func) { return
//         return_param{a_func.second};
//         //                });
...
//         {
//             l_node_children[i] =
//                 build_function(a_program, a_scope, a_param_types,
//                 a_repr_stream,
...
//             a_program, a_scope, l_func_param_types_multimap,
//             l_func_repr_stream, l_func_return_type, false, a_simulation,
//             a_recursion_limit);
...
//     throw std::runtime_error("Error: invalid choice when building
//     function.");
// }
